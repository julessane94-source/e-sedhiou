        ...
        <section class="hero">
            <div class="hero__panel">
                <div class="tw:flex tw:items-center tw:gap-3">
                    <span class="tw:text-5xl"><?php echo e($course->icon_emoji ?? '📚'); ?></span>
                    <div>
                        <span class="eyebrow">Cours Citoyen</span>
                        <h1 class="tw:font-semibold"><?php echo e($course->title); ?></h1>
                    </div>
                </div>
                <p class="muted tw:mt-3"><?php echo e($course->description); ?></p>
                <div class="actions tw:mt-4">
                    <a class="button button--ghost" href="<?php echo e(route('portal.citizen')); ?>">← Retour aux cours</a>
                </div>
            </div>
        </section>
    </div>
    ...
    <section class="section">
        <div class="tw:grid tw:grid-cols-1 lg:tw:grid-cols-3 tw:gap-6">
            ...
            <div class="lg:tw:col-span-2">
                    ...
                    <div class="tw:grid tw:grid-cols-2 md:tw:grid-cols-4 tw:gap-4">
                        <div class="tw:text-center">
                            ...
                            <p class="tw:font-semibold tw:text-emerald-700">
                                <i class="bi bi-clock me-1"></i><?php echo e($course->duration_minutes); ?> min
                            </p>
                        </div>
                        <div class="tw:text-center">
                            ...
                            <p class="tw:font-semibold tw:text-emerald-700">
                                ...
                                <?php elseif($course->course_type === 'hybrid'): ?>
                        ...
                        <div class="tw:text-center">
                            ...
                            <p class="tw:font-semibold tw:text-emerald-700">
                                <?php if($course->difficulty_level === 'beginner'): ?>
                                    <i class="bi bi-cup-hot me-1"></i>Débutant
                                <?php elseif($course->difficulty_level === 'intermediate'): ?>
                ...
                <!-- Fichiers joints -->
                <?php if($course->image_path || $course->document_path): ?>
                    <div class="panel tw:rounded-2xl tw:border tw:border-emerald-200/60 tw:bg-white/95 tw:p-6">
                        <h2 class="tw:text-xl tw:font-semibold tw:text-gray-900 tw:mb-4">
                            ...
                            <?php if($course->image_path): ?>
                                <div class="tw:flex tw:items-center tw:gap-3 tw:p-3 tw:bg-emerald-50/50 tw:rounded-lg tw:border tw:border-emerald-200/40">
                                    ...
                                    <div class="tw:flex-1">
                                        ...
                                        <p class="tw:text-xs tw:text-gray-600"><?php echo e($course->image_name ?? 'image.jpg'); ?></p>
                                    </div>
                                    <a href="<?php echo e(asset('storage/' . $course->image_path)); ?>" target="_blank" class="button button--ghost tw:px-3 tw:py-2" title="Voir l'image">
                            ...
                            <?php if($course->document_path): ?>
                                <div class="tw:flex tw:items-center tw:gap-3 tw:p-3 tw:bg-emerald-50/50 tw:rounded-lg tw:border tw:border-emerald-200/40">
                                    ...
                                    <div class="tw:flex-1">
                                        ...
                                        <p class="tw:text-xs tw:text-gray-600"><?php echo e($course->document_name ?? 'document.pdf'); ?></p>
                                    </div>
                                    <a href="<?php echo e(asset('storage/' . $course->document_path)); ?>" target="_blank" download class="button button--ghost tw:px-3 tw:py-2" title="Télécharger">
                                        <i class="bi bi-download"></i>
                                    </a>
                                </div>
                            <?php endif; ?>
            ...
            <div class="tw:space-y-6">
                ...
                <div class="panel tw:rounded-2xl tw:border-2 tw:border-emerald-400 tw:bg-emerald-50/50 tw:p-6 tw:sticky tw:top-4">
                    <div class="tw:text-center tw:space-y-3">
                        ...
                        <div class="tw:space-y-2">
                            <a href="<?php echo e(route('portal.citizen.course.view', ['civicCourse' => $course->id])); ?>" class="button button--primary tw:w-full">
                                <i class="bi bi-book-half me-2"></i>Commencer le cours
                            </a>
                            <a href="<?php echo e(route('portal.citizen')); ?>" class="button button--ghost tw:w-full">
                ...
                <div class="panel tw:rounded-2xl tw:border tw:border-gray-200 tw:bg-white tw:p-6">
                    ...
                    <div class="tw:space-y-3 tw:text-sm">
                        <div>
                            ...
                            <p class="tw:text-gray-900"><?php echo e($course->createdBy?->name ?? 'Admin'); ?></p>
                        </div>
                        <div>
                            <p class="tw:text-xs tw:text-gray-600 tw:uppercase tw:tracking-wide">Date de création</p>
                            <p class="tw:text-gray-900"><?php echo e($course->created_at->format('d M Y')); ?></p>
                        </div>
                        <div>
                            <p class="tw:text-xs tw:text-gray-600 tw:uppercase tw:tracking-wide">Dernière mise à jour</p>
                            <p class="tw:text-gray-900"><?php echo e($course->updated_at->format('d M Y à H:i')); ?></p>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('portal.layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\mairie_wp\backend-laravel\resources\views/portal/course-detail.blade.php ENDPATH**/ ?>