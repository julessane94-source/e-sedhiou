...
<head>
    ...
    <title><?php echo e($pageTitle ?? 'Portail mairie'); ?></title>
...
<body class="tw:antialiased tw:bg-emerald-50/30">
    <header class="topbar navbar navbar-expand-lg tw:sticky tw:top-0 tw:z-40 tw:backdrop-blur-sm">
        <div class="shell container-fluid topbar__inner px-0 tw:gap-4">
            <div class="brand navbar-brand me-auto">
                <img src="<?php echo e($senegalFlagUrl ?? asset('senegal-flag.svg')); ?>" alt="Drapeau Sénégal" class="brand__mark" style="width: 44px; height: 44px; border-radius: 8px; object-fit: cover;">
                <div class="brand__text">
                    <strong><?php echo e($portalSettings['site_name'] ?? 'Portail Mairie'); ?></strong>
                    <?php if(! empty($portalSettings['site_description'])): ?>
                        <div class="scroll-container">
                            <span class="scroll-text"><?php echo e($portalSettings['site_description']); ?>&nbsp;&nbsp;&nbsp;&nbsp;<?php echo e($portalSettings['site_description']); ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="collapse navbar-collapse" id="portalNav">
                <nav class="navbar-nav ms-auto align-items-lg-center gap-2 mt-2 mt-lg-0">
                    <a class="nav-link" href="<?php echo e($wordpressUrl); ?>/"><i class="bi bi-house me-1"></i>Accueil</a>
                    <?php $__currentLoopData = $portalLinks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $portalLink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <a class="nav-link" href="<?php echo e($portalLink['url']); ?>"><?php echo e($portalLink['label']); ?></a>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <?php if($currentUser): ?>
                        <form action="<?php echo e(route('portal.logout')); ?>" method="post" class="tw:inline">
                            <?php echo csrf_field(); ?>
                    ...
                    <?php else: ?>
                        <a class="btn btn-success rounded-pill px-4" href="<?php echo e(route('portal.auth')); ?>">
    ...
    <main class="shell tw:py-4 md:tw:py-6">
        <?php if(session('status')): ?>
            <div class="notice notice--<?php echo e(session('status_type', 'success')); ?> tw:mt-5">
...
<?php /**PATH C:\xampp\htdocs\mairie_wp\backend-laravel\resources\views/portal/layout.blade.php ENDPATH**/ ?>